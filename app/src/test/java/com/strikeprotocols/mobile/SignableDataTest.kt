...
class SignableDataTest {
    ...
    fun testDAppTransactionRequestInitiationRequest() {
        ...
        Assert.assertEquals(
            ...
            initiationRequest.retrieveSignableData(approverPublicKey = "6f51NkToPKgK2AY6GGf7scdbwXpZGNmkx6wvCdp9rQPW")
                .toHexString()
        )

        val supplyInstructions = initiationRequest.supplyInstructions
        Assert.assertEquals(supplyInstructions.size, 2)
        ...
        Assert.assertEquals(
            ...
            supplyInstructions[0].retrieveSignableData(approverPublicKey = "6f51NkToPKgK2AY6GGf7scdbwXpZGNmkx6wvCdp9rQPW").toHexString()
        )

        Assert.assertEquals(supplyInstructions[1].nonce, nonces[2])
        Assert.assertEquals(supplyInstructions[1].nonceAccountAddress, nonceAccountAddresses[2])
        Assert.assertEquals(
            ...
            supplyInstructions[1].retrieveSignableData(approverPublicKey = "6f51NkToPKgK2AY6GGf7scdbwXpZGNmkx6wvCdp9rQPW").toHexString()
        )
    }
    ...
    fun testDAppTransactionRequestApprovalDisposition() {
        ...
        Assert.assertEquals(
            approvalRequest.retrieveSignableData(approverPublicKey = "9vgBZg7RPtcwkMLrs2VSDeWQjfbyChy1SLbiWhRxod5U")
                .toHexString(),
