...
sealed class SolanaApprovalRequestDetails {
    ...
    data class ApprovalRequestDetails(val requestType: com.censocustody.android.data.models.approval.ApprovalRequestDetails) :
        SolanaApprovalRequestDetails()

    data class MultiSignOpInitiationDetails(
        val multisigOpInitiation: MultiSigOpInitiation,
        val requestType: com.censocustody.android.data.models.approval.ApprovalRequestDetails
    ) : SolanaApprovalRequestDetails()
