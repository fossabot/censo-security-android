...
interface CryptographyManager {
     ...
     * with the key. The secret key uses [DECRYPT_MODE][Cipher.DECRYPT_MODE] is used.
     */
    fun getInitializedCipherForDeviceKeyDecryption(keyName: String, initializationVector: ByteArray): Cipher
...
class CryptographyManagerImpl : CryptographyManager {
    ...
    override fun getInitializedCipherForDeviceKeyDecryption(
        keyName: String,
