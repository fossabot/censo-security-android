...
enum class KeyCreationFlowStep {
    ENTRY_STEP, COPY_PHRASE_STEP, PHRASE_COPIED_STEP, PHRASE_SAVED_STEP, WRITE_WORD_STEP,
    CONFIRM_KEY_ENTRY_STEP, CONFIRM_KEY_ERROR_STEP, ALL_SET_STEP, UNINITIALIZED, FINISHED
}

enum class KeyRecoveryFlowStep {
    ENTRY_STEP, CONFIRM_KEY_ENTRY_STEP, CONFIRM_KEY_ERROR_STEP, ALL_SET_STEP, UNINITIALIZED, FINISHED
}
